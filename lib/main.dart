...
void main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImplZWxlY3RlaXJiYWF3dGRoY2x3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA3MTgxNzMsImV4cCI6MjA4NjI5NDE3M30.TTgEaT0sT23gYh0VgJ4FtXNMNy7XD-joyyjUJ4gfz7E',
  );

  runApp(const ProviderScope(child: StorelyticsApp()));
}
